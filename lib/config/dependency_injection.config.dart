...
import '../domain/repositories/cycle_repository.dart' as _i951;
...
import '../domain/usecases/complete_cycle.dart' as _i814;
...
_i174.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i544.UserRepository>(
      () => _i223.UserRepositoryImpl(gh<_i974.FirebaseFirestore>()));
  ...
  gh.lazySingleton<_i951.CycleRepository>(
      () => _i0.CycleRepositoryImpl(gh<_i916.CycleRemoteDataSource>()));
  gh.lazySingleton<_i814.CompleteCycle>(() => _i814.CompleteCycle(
        gh<_i951.CycleRepository>(),
        gh<_i544.UserRepository>(),
      ));
  gh.lazySingleton<_i549.AddManualTrade>(
      () => _i549.AddManualTrade(gh<_i951.CycleRepository>()));
  gh.lazySingleton<_i616.AddNewCycle>(
      () => _i616.AddNewCycle(gh<_i951.CycleRepository>()));
  gh.lazySingleton<_i561.CalculatePortfolio>(
      () => _i561.CalculatePortfolio(gh<_i951.CycleRepository>()));
  gh.lazySingleton<_i960.GetAllCycles>(
      () => _i960.GetAllCycles(gh<_i951.CycleRepository>()));
  gh.lazySingleton<_i512.UpdateTradeResult>(
      () => _i512.UpdateTradeResult(gh<_i951.CycleRepository>()));
  gh.factory<_i327.CycleDetailViewModel>(() => _i327.CycleDetailViewModel(
        gh<_i561.CalculatePortfolio>(),
        gh<_i814.CompleteCycle>(),
      ));
